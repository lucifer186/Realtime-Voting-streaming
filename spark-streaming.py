...
if __name__ == "__main__":
    ...
    spark = (SparkSession.builder
             ...
             .config("spark.jars.packages",
                     "org.apache.spark:spark-sql-kafka-0-10_2.13:4.0.0")  # Spark-Kafka integration
             .config("spark.jars", r"D:\software\Project\voting_2.0\postgresql-42.7.1.jar")  # PostgreSQL driver
    ...
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", r"D:\software\Project\voting_2.0\checkpoints\checkpoint1") \
        .outputMode("update") \
        .start()
    ...
    turnout_by_location_to_kafka = turnout_by_location.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", r"D:\software\Project\voting_2.0\checkpoints\checkpoint2") \
        .outputMode("update") \
        .start()
